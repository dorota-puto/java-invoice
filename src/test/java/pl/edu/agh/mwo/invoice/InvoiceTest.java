...
public class InvoiceTest {
    ...
    public void testEmptyInvoiceHasEmptyTotal() {
        Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getGroosPrice()));
    }
    ...
    public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
        ...
        Assert.assertThat(invoice.getGroosPrice(), Matchers.comparesEqualTo(invoice.getNetPrice()));
    }
    ...
    public void testInvoiceHasProperTotalValueForManyProduct() {
        ...
        Assert.assertThat(new BigDecimal("320.30"), Matchers.comparesEqualTo(invoice.getGroosPrice()));
    }
    ...
    public void testInvoiceHasPropoerTotalWithQuantityMoreThanOne() {
        ...
        invoice.addProduct(new OtherProduct("Pinezka", new BigDecimal("0.01")), 1000);
        Assert.assertThat(new BigDecimal("54.70"), Matchers.comparesEqualTo(invoice.getGroosPrice()));
    }
